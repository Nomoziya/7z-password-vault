...
dev3 历史验收保留。dev4 已补齐全部计划功能；三种语言实际 150% 缩放的恢复专项各 45/45，普通桌面完整 GUI 436/0，独立 cs 账户在 200% 缩放下完整 GUI 436/0，升级回滚、跨账户 DPAPI 拒绝、最终原生 EXE 的真实磁盘满和干净重建均通过。已收齐最终候选证据，准备同哈希 EXE 的未签名公开候选包；尚未上传 GitHub 或发布新正式标签。
